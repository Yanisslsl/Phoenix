...
This example shows how to use the Perlin noise generator to create a simple 2D map. 
The perlin noise is rendered in an image see below to see the usage.
...
6. Compile the project and run [BUILD-NAME]/Game [filename] [width] [height] [numberOctaves] to run the executable.